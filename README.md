...
|**MIDIファイルから自作楽譜**|[Page](https://anesewo.github.io/tools/midi_scratch)|[README](https://github.com/anesewo/tools/tree/main/midi_scratch)|
|**ymmpから字幕ファイル**|[Page](https://anesewo.github.io/tools/ymm4vtt)|[README](https://github.com/anesewo/tools/tree/main/ymm4vtt)|
...
1. **ライブラリの性質を引き継ぐ場合**: 使用している主要ライブラリに 強力なコピーレフト性（LGPL, GPL, CC BY-SA 等） があり、その制約がツール自体に及ぶ場合は、該当するライブラリのライセンスが適用されます。
2. **個別規定がある場合**: 各ツール内のコメントや説明にライセンス指定がある場合は、そちらが適用されます。
